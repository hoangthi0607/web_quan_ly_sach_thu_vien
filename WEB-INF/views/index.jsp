...
<body id="page-top">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="#danhmuc">Danh mục</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="#about">About</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="#contact">Contact</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="login.htm?linklogout">Logout</a></li>
	...
	<!-- Portfolio Section-->
	<section class="page-section portfolio" id="danhmuc">
		<div class="container">
			<!-- Portfolio Section Heading-->
			<h2
				class="page-section-heading text-center text-uppercase text-secondary mb-0">Danh mục</h2>
			<!-- Icon Divider-->
			...
			<div class="row justify-content-center">
				...
				<div class="col-md-6 col-lg-4 mb-5">
					<a class="portfolio-item mx-auto" href="khosach.htm">
						<div
						...
						<div style="display: flex; justify-content: center; font-size:30px;">Danh sách sách</div>
						<img class="img-fluid" src="assets/img/portfolio/book.png" style=" width:356px; height:257px;"
							alt="..." />
					</a>
				</div>
				<!-- Portfolio Item 2-->
